...
def improvement_features_results(n, alternative_to_improve, alternative_to_overcame, epsilon, features_to_change, boundary_values, method):    
    global proceed
    proceed = False
    global improvement
    if alternative_to_improve is None or alternative_to_overcame is None or features_to_change is None:
    ...
    if n>0:
        ...
        try:
            improvement = buses_g.improvement(method, alternative_to_improve,alternative_to_overcame, epsilon, features_to_change = features_to_change, boundary_values = boundary_values)
        except Exception as e:
            print(e)
            no_exception = False
...
def improvement_std_results(n, alternative_to_improve, alternative_to_overcame, epsilon, method, solutions_number):    
    global proceed
    proceed = False
    global improvement
    if alternative_to_improve is None or alternative_to_overcame is None:
    ...
    if n>0:
        ...
        try:
            improvement = buses_g.improvement(method, alternative_to_improve,alternative_to_overcame, epsilon, solutions_number = solutions_number)
        except Exception as e:
            print(e)
            no_exception = False
